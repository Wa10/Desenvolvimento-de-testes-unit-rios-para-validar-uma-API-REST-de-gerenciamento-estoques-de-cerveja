...
public class BeerControllerTest {
    ...
    @Test
    void whenGETIsCalledWithValidNameThenOkStatusIsReturn() throws Exception {
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenGETListWithBeersIsCalleThenOkStatusIsReturn() throws Exception {
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenGETListWithoutBeersIsCalleThenOkStatusIsReturn() throws Exception {
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenDELETEisCalledWithInvalidIdThenNoFoundStatusIsReturn() throws Exception {
